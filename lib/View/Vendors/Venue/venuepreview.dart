...
class Venuepreview extends StatefulWidget {
  ...
  @override
  State<Venuepreview> createState() => _VenuepreviewState();
}

class _VenuepreviewState extends State<Venuepreview> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        \n-     Lawns: Outdoor area for additional\n      wedding activities or ceremonies
                                             \n-    Breakfast: Morning meal for guests
                                        \n-     Lunch: Midday meal for guests
                                        \n-     Dinner: Evening meal for guests
                                        \n-     Alcohol: Beverage service, including \n      alcoholic drinks''',
                                          style: TextStyle(
                                            color: Color(0xFF373434),
                                            fontSize: 14,
                                            fontFamily: 'AvenirNextCyr',
