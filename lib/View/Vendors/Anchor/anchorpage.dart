...
class _AnchorPageState extends State<AnchorPage> {
  List anchordata = [
    {
      "image": "assets/images/anchor1.png",
      "subtext": "Malad , Mumbai",
      "tittle": "Anchor Kartikey",
    },
    {
      "image": "assets/images/anchor2.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Anchor Kartikey",
    },
    {
      "image": "assets/images/anchor3.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Anchor Kartikey",
    },
    {
      "image": "assets/images/anchor4.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Anchor Kartikey",
    },
    {
      "image": "assets/images/anchor5.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Anchor Kartikey",
    },
  ];
            ...
            Expanded(
              child: SingleChildScrollView(
                child: ListView.separated(
                    ...
                    itemCount: anchordata.length,
                    itemBuilder: (context, index) {
                      return catercard(
                          anchordata[index]["image"],
                          anchordata[index]["subtext"],
                          anchordata[index]["tittle"]);
                    }),
              ),
            ),
            sizedBoxHeight(30.h),
        ...
        child: Column(
          ...
          children: [
            ...
            commonNextButton("View",onTap: () {
                    Get.toNamed(RouteName.anchorpreview);   
            },)
          ],
        ),
      ),
