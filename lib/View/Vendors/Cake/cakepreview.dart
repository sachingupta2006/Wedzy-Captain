...
class Cakepreview extends StatefulWidget {
  const Cakepreview({super.key});

  @override
  State<Cakepreview> createState() => _CakepreviewState();
}
...
class _CakepreviewState extends State<Cakepreview> {
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                              "assets/svg/starcircle.svg",
                                              width: 18.w,
                                              height: 18.h,
                                            ),
                                            sizedBoxWidth(5.w),
                                            text373434_18w400("Specialty -")
                                          ],
                                        ),
                                      ),
                                      sizedBoxHeight(8.h),
                                      Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              SvgPicture.asset(
                                                  "assets/svg/horizontalline.svg"),
                                              sizedBoxWidth(8.w),
                                              text373434_14w400("Cake in a jar")
                                            ],
                                          )),
                                      sizedBoxHeight(4.h),
                                      Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              SvgPicture.asset(
                                                  "assets/svg/horizontalline.svg"),
                                              sizedBoxWidth(8.w),
                                              text373434_14w400("Wedding cakes")
                                            ],
                                          )),
                                      sizedBoxHeight(4.h),
                                      Padding(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                              "assets/svg/cakeround.svg",
                                              width: 18.w,
                                              height: 18.h,
                                            ),
                                            sizedBoxWidth(5.w),
                                            text373434_18w400("Flavors -")
                                          ],
                                        ),
                                      ),
                                      sizedBoxHeight(8.h),
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return cakecard(
                          ...
                          cakedata[index]["subtext"],
                          cakedata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
  ...
  Widget cakecard(dynamic image, dynamic subtext, dynamic tittle) {
    return Container(
      width: 328,
      height: 277,
      decoration: ShapeDecoration(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    // Get.toNamed(RouteName.cakepreview);
                  },
                  child: Container(
                    width: 95,
                    height: 34,
