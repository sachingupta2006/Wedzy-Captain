...
class Jewellerypreview extends StatefulWidget {
  const Jewellerypreview({super.key});

  @override
  State<Jewellerypreview> createState() => _JewellerypreviewState();
}

class _JewellerypreviewState extends State<Jewellerypreview> {
  ...
  List images = [
    ...
    {
      "image": "assets/images/makeup7.png",
    },
    {
      "image": "assets/images/makeup6.png",
    },
                ...
                children: [
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/jewellery1.png"),
                        fit: BoxFit.fill,
                      ),
                      shape: RoundedRectangleBorder(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      sizedBoxWidth(4.w),
                      textBlack16w500("Sailee Jewellers"),
                      sizedBoxWidth(102.w),
                      SvgPicture.asset(
                  ...
                  ListView.separated(
                    ...
                    itemCount: jewellerydata.length,
                    itemBuilder: (context, index) {
                      return jewellerycard(
                          jewellerydata[index]["image"],
                          jewellerydata[index]["subtext"],
                          jewellerydata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
  ...
  Widget jewellerycard(dynamic image, dynamic subtext, dynamic tittle) {
    return Container(
      width: 328,
      height: 277,
      decoration: ShapeDecoration(
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    text373737_12w400("Jewellery price"),
                    text373434_18w700("₹ 30,000")
                  ],
                ),
                GestureDetector(
                  onTap: () {
                    // Get.toNamed(RouteName.jewellerypreview);
                  },
                  child: Container(
                    width: 95,
                    height: 34,
