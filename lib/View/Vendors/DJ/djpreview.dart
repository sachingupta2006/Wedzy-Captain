...
class DJpreview extends StatefulWidget {
  const DJpreview({super.key});

  @override
  State<DJpreview> createState() => _DJpreviewState();
}

class _DJpreviewState extends State<DJpreview> {
  ...
  List images = [
    {
      "image": "assets/images/dj5.png",
    },
    {
      "image": "assets/images/dj6.png",
    },
    {
      "image": "assets/images/dj5.png",
    },
              ...
              child: Column(
                ...
                children: [
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: text373434_15w700(
                                            "Tower speakers, Amplifier, Mixer console,\nDJ, 2 cordless, 5 led far light with stand"),
                                      ),
                                      sizedBoxHeight(28.h),
                                    ],
                                  ))
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return bartendercard(djdata[index]["image"],
                          djdata[index]["subtext"], djdata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
