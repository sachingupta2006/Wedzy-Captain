...
class Choreopreview extends StatefulWidget {
  const Choreopreview({super.key});

  @override
  State<Choreopreview> createState() => _ChoreopreviewState();
}

class _ChoreopreviewState extends State<Choreopreview> {
  ...
  List images = [
    {
      "image": "assets/images/choreo6.png",
    },
    {
      "image": "assets/images/choreo7.png",
    },
    {
      "image": "assets/images/choreo6.png",
    },
  ...
  List choreodata = [
    {
      "image": "assets/images/choreo3.png",
      "subtext": "Malad , Mumbai",
      "tittle": "Chait’s Dance Studio",
    },
    {
      "image": "assets/images/choreo4.png",
      "subtext": "Malad , Mumbai",
      "tittle": "Chait’s Dance Studio",
    },
    {
      "image": "assets/images/choreo5.png",
      "subtext": "Malad , Mumbai",
      "tittle": "Chait’s Dance Studio",
    },
  ];
                ...
                children: [
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/choreo1.png"),
                        fit: BoxFit.fill,
                      ),
                      shape: RoundedRectangleBorder(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      sizedBoxWidth(4.w),
                      textBlack16w500("Chait’s Dance Studio"),
                      sizedBoxWidth(62.w),
                      SvgPicture.asset(
                  ...
                  ListView.separated(
                    ...
                    itemCount: choreodata.length,
                    itemBuilder: (context, index) {
                      return choreocard(
                          choreodata[index]["image"],
                          choreodata[index]["subtext"],
                          choreodata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
  ...
  Widget choreocard(dynamic image, dynamic subtext, dynamic tittle) {
    return Container(
      width: 328,
      height: 257,
      decoration: ShapeDecoration(
        ...
        child: Column(
          ...
          children: [
            ...
            commonNextButton(
              "View",
              onTap: () {
                // Get.toNamed(RouteName.choreopreview);
              },
            )
          ],
        ),
