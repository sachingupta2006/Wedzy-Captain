...
class Bartenderpreview extends StatefulWidget {
  const Bartenderpreview({super.key});

  @override
  State<Bartenderpreview> createState() => _BartenderpreviewState();
}

class _BartenderpreviewState extends State<Bartenderpreview> {
  ...
  List images = [
    {
      "image": "assets/images/bar6.png",
    },
    {
      "image": "assets/images/bar7.png",
    },
    {
      "image": "assets/images/bar6.png",
    },
              ...
              child: Column(
                ...
                children: [
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                                "assets/svg/dot.svg"),
                                            sizedBoxWidth(16.w),
                                            text373434_15w400("1 Lead Bartenders")
                                          ],
                                        ),
                                      ),
                                      sizedBoxHeight(10.h),
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                                "assets/svg/dot.svg"),
                                            sizedBoxWidth(16.w),
                                            text373434_15w400("2 Flair Bartenders")
                                          ],
                                        ),
                                      ),
                                       sizedBoxHeight(10.h),
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                                "assets/svg/dot.svg"),
                                            sizedBoxWidth(16.w),
                                            text373434_15w400("3 Bar Rovers")
                                          ],
                                        ),
                                      ),
                                       sizedBoxHeight(10.h),
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset(
                                                "assets/svg/dot.svg"),
                                            sizedBoxWidth(16.w),
                                            text373434_15w400("2 Mixologist")
                                          ],
                                        ),
                                      ),
                                      sizedBoxHeight(28.h),
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return bartendercard(bardata[index]["image"],
                          bardata[index]["subtext"], bardata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
