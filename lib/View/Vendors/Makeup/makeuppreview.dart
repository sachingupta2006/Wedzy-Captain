...
class Makeuppreview extends StatefulWidget {
  const Makeuppreview({super.key});

  @override
  State<Makeuppreview> createState() => _MakeuppreviewState();
}

class _MakeuppreviewState extends State<Makeuppreview> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      sizedBoxWidth(4.w),
                      textBlack16w500("Namrata’s Salon"),
                      sizedBoxWidth(102.w),
                      SvgPicture.asset(
