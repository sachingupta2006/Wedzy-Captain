...
class Photographypreview extends StatefulWidget {
  const Photographypreview({super.key});

  @override
  State<Photographypreview> createState() => _PhotographypreviewState();
}

class _PhotographypreviewState extends State<Photographypreview> {
  ...
  List images = [
    {
      "image": "assets/images/venue8.png",
    },
    {
      "image": "assets/images/venue8.png",
    },
  ...
  List venuedata = [
    {
      "image": "assets/images/photography3.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Captured Moments studio",
    },
    {
      "image": "assets/images/photography4.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Captured Moments studio",
    },
    {
      "image": "assets/images/photography5.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Captured Moments studio",
    },
  ];
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/photography1.png"),
                        fit: BoxFit.fill,
                      ),
                      shape: RoundedRectangleBorder(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Padding(
                                padding:
                                    EdgeInsets.only(left: 14.w, right: 18.w),
                                child: Row(
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return photocard(
                          venuedata[index]["image"],
                          venuedata[index]["subtext"],
                          venuedata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
  ...
  // Widget venuecard(dynamic image, dynamic subtext, dynamic tittle) {
  //   return Container(
  //     width: 328,
  //     height: 277,
  //     decoration: ShapeDecoration(
  ...
  //               GestureDetector(
  //                 onTap: () {
  //                   // Get.toNamed(RouteName.venuepreview);
  //                 },
  //                 child: Container(
  //                   width: 95,
  //                   height: 34,
  ...
  Widget photocard(dynamic image, dynamic subtext, dynamic tittle) {
    return Container(
      width: 328,
      height: 277,
      decoration: ShapeDecoration(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    // Get.toNamed(RouteName.photographypreview);
                  },
                  child: Container(
                    width: 95,
                    height: 34,
