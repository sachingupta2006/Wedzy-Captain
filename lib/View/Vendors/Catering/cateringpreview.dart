...
class Cateringpreview extends StatefulWidget {
  const Cateringpreview({super.key});

  @override
  State<Cateringpreview> createState() => _CateringpreviewState();
}

class _CateringpreviewState extends State<Cateringpreview> {
  ...
  List images = [
    {
      "image": "assets/images/cater6.png",
    },
    {
      "image": "assets/images/cater7.png",
    },
    {
      "image": "assets/images/cater6.png",
    },
  ...
  List caterdata = [
    {
      "image": "assets/images/cater2.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Pooja Caterers",
    },
    {
      "image": "assets/images/cater4.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Pooja Caterers",
    },
    {
      "image": "assets/images/cater5.png",
      "subtext": "Borivali , Mumbai",
      "tittle": "Pooja Caterers",
    },
  ];
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/cater1.png"),
                        fit: BoxFit.fill,
                      ),
                      shape: RoundedRectangleBorder(
                  ...
                  ListView.separated(
                    ...
                    itemCount: caterdata.length,
                    itemBuilder: (context, index) {
                      return catercard(
                          caterdata[index]["image"],
                          caterdata[index]["subtext"],
                          caterdata[index]["tittle"]);
                    },
                  ),
                  sizedBoxHeight(70.h),
                ],
  ...
  Widget catercard(dynamic image, dynamic subtext, dynamic tittle) {
    return Container(
      width: 328,
      height: 257,
      decoration: ShapeDecoration(
        ...
        child: Column(
          ...
          children: [
            ...
            commonNextButton("View",onTap: () {
                    // Get.toNamed(RouteName.cateringpreview);   
            },)
          ],
        ),
      ),
